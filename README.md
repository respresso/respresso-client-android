...
[Respresso](https://respresso.io) is a centralized resource manager for shared Android, [iOS](https://github.com/pontehu/respresso-sync-for-clients#ios) and [Web frontend](https://github.com/pontehu/respresso-sync-for-clients#web) projects.
